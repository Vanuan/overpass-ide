...
var ide = new(function() {
  ...
  this.setDataViewerMode = function(mode) {
    dataViewer.setOption("mode",mode);
  }
        ...
        "Load" : function() {
          $("input",this).each(function(i,inp) {
            if (inp.checked) {
              ...
              if (typeof settings.saves[inp.value].js != "undefined")
                ide.setScript(settings.saves[inp.value].js);
              else
                ide.setScript("");
            }
          });
